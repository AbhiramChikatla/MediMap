...
export default function DashboardPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold mb-8 text-blue-600 text-center">MediMap Dashboard</h1>
      
      <Tabs defaultValue="find-care" className="w-full mb-8">
        <TabsList className="grid w-full grid-cols-2">
          <TabsTrigger value="find-care">Find Healthcare</TabsTrigger>
          <TabsTrigger value="health-dashboard">Health Dashboard</TabsTrigger>
        </TabsList>
        
        <TabsContent value="find-care">
          <h2 className="text-2xl font-semibold mb-6 text-blue-600">Find Healthcare Centers Near You</h2>
        ...
        <div className="flex flex-col">
          ...
          {showResults && (
            <div className="mt-8">
              <h2 className="text-2xl font-semibold mb-4">Healthcare Centers Near You</h2>
