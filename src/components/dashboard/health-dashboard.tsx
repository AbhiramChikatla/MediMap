            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                ...
                <Card>
                    <CardHeader className="pb-2">
                        ...
                        <CardDescription>
                            For optimal exercise intensity
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
                        <div className="text-3xl font-bold">
                            {heartRateZone.lower} - {heartRateZone.upper}
                        </div>
                        <p className="text-sm text-muted-foreground">
                            beats per minute
                        </p>
                ...
                <TabsContent value="nutrition" className="mt-6">
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Track your daily nutrition intake and get
                ...
                <TabsContent value="activity" className="mt-6">
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Track your physical activities and exercise
                                routines
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
