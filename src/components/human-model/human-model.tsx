...
const bodyPartSymptoms: Record<string, string[]> = {
    ...
    back: ["Upper back pain", "Lower back pain", "Spine pain", "Muscle spasms"],
    arms: ["Arm pain", "Joint pain", "Muscle weakness", "Numbness", "Tingling"],
    hands: [
        "Hand pain",
        "Finger numbness",
        "Wrist pain",
    ...
    feet: ["Foot pain", "Heel pain", "Toe numbness", "Swelling"],
};
        ...
        try {
            ...
            clonedScene.traverse((node) => {
                if (node instanceof THREE.Mesh) {
                    ...
                    else if (name.includes("chest") || name.includes("thorax"))
                        bodyPart = "chest";
                    else if (
            ...
            {hoveredPart && (
                <Html position={[0, 2.2, 0]} center>
                    <div className="bg-white px-2 py-1 rounded-md shadow-md text-sm">
                        {hoveredPart.charAt(0).toUpperCase() +
                            hoveredPart.slice(1)}
                    </div>
                </Html>
            )}
            ...
            <Card className="flex-1 overflow-auto">
                <CardContent className="p-4">
                    <h3 className="text-lg font-semibold mb-4">
                        {selectedPart
                            ? `Select symptoms for: ${
                                  selectedPart.charAt(0).toUpperCase() +
                                  selectedPart.slice(1)
                              }`
                    ...
                    {selectedPart ? (
                        ...
                        <p className="text-gray-500 italic">
                            Touch any part of the human model to see related
                            symptoms
                        </p>
                    )}
