...
const healthTips: HealthTip[] = [
  ...
  },
  {
    ...
    content: 'Take short mental breaks throughout the day to reduce stress and improve focus.',
    category: 'mental'
  },
  {
    id: 5,
    title: 'Adequate Sleep',
    content: 'Aim for 7-9 hours of quality sleep each night to support overall health and immune function.',
    category: 'general'
  },
  {
    id: 6,
    title: 'Limit Processed Foods',
    content: 'Reduce intake of highly processed foods that are often high in sugar, salt, and unhealthy fats.',
    category: 'nutrition'
  }
];
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
            Simple, evidence-based tips to help you maintain optimal health and wellbeing.
          </p>
        </motion.div>
