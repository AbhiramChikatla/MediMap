                ...
                >
                    <div className="flex flex-col gap-6 max-w-[640px] mx-auto text-center">
                        <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold leading-tight tracking-tighter text-black dark:text-white">
                            Find the Best{" "}
                            <span className="text-black dark:text-white border-b-2 border-black dark:border-white">
                                Healthcare Centers
                            </span>{" "}
                            Near You
                        </h1>
                        ...
                        <p className="text-lg md:text-xl text-gray-800 dark:text-gray-200 mb-8 max-w-2xl mx-auto">
                            Discover and compare healthcare centers based on
                            wait times, services, and patient reviews. Make
                        ...
                        <div className="flex flex-wrap gap-4 justify-center">
                            {!isSignedIn ? (
                                <SignUpButton mode="modal">
                                    <Button
                                        size="lg"
                                        className="rounded-full px-8 bg-gradient-to-r from-blue-600 to-cyan-500 hover:from-blue-700 hover:to-cyan-600 border-0"
                                    >
                                        Get Started
                                    </Button>
                                </SignUpButton>
