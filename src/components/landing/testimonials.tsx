            ...
            <div className="container px-4 md:px-6">
                <div className="text-center mb-16">
                    ...
                    <p className="text-xl text-gray-600">
                        Join thousands of companies already using Medimap
                    </p>
                </div>
                ...
                <div className="grid md:grid-cols-3 gap-8">
                    <Card>
                        <CardContent className="pt-6">
                            ...
                            <p className="text-gray-600 mb-4">
                                "Medimap transformed our workflow completely.
                                We've reduced project completion time by 60% and
                    ...
                    <Card>
                        <CardContent className="pt-6">
                            ...
                            <p className="text-gray-600 mb-4">
                                "The AI automation features are incredible.
                                Tasks that used to take hours now happen
                                automatically. It's like having a
                                super-efficient assistant."
                            </p>
                            <div className="flex items-center">
                                <Image
                    ...
                    <Card>
                        <CardContent className="pt-6">
                            ...
                            <p className="text-gray-600 mb-4">
                                "Finally, a tool that actually delivers on its
                                promises. Our team collaboration has improved
