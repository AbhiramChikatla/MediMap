    ...
    const handleFindRoute = async (
        ...
        try {
            ...
            if (useCurrentLocation && userCoords) {
                ...
                const sourceResult = await new Promise<
            ...
            const destResult = await new Promise<google.maps.GeocoderResult[]>(
                (resolve, reject) => {
                    geocoder.geocode(
                        { address: destination },
                        (results, status) => {
            ...
            const directionsResult =
                await new Promise<google.maps.DirectionsResult>(
                    (resolve, reject) => {
            ...
            alert(
                "Failed to find route. Please check the addresses and try again."
            );
        } finally {
                    ...
                    <Card className="mt-4 shadow-md">
                        <CardContent className="p-4">
                            ...
                            <div className="space-y-2 text-sm">
                                <p>
                                    <strong>From:</strong> {routeInfo.source}
                                </p>
                                <p>
                                    <strong>To:</strong> {routeInfo.destination}
                                </p>
                                {routeInfo.distance && (
                                    <p>
