...
export default function MapComponent({
        ...
        async (
            ...
            try {
                ...
                const routeInfoData: RouteInfo = {
                    ...
                    duration:
                        distanceMatrixData.rows[0].elements[0].duration.text,
                ...
                alert(
                    "Could not find a route. Please check the addresses and try again."
                );
            } finally {
    ...
    if (
        ...
        locationStatus === LocationStatus.MANUAL_INPUT
    ) {
        return (
                    ...
                    {coords ? (
                        ...
                        <div className="h-full flex items-center justify-center">
                            <div className="text-center p-4">
                                <p className="mb-4">
                                    Could not determine your location. Please
                                    enter it manually.
                                </p>
                            </div>
                        </div>
            ...
            <Card className="w-full h-full overflow-hidden border-0 shadow-none">
                <CardContent className="p-4 h-full flex items-center justify-center">
                    <div className="text-center max-w-md">
                        ...
                        <p className="mb-4">
                            We couldn't detect your precise location. Would you
                            like to:
                        </p>
            ...
            <Card className="w-full h-full overflow-hidden border-0 shadow-none">
                <CardContent className="p-4 h-full flex items-center justify-center">
                    <div className="text-center max-w-md">
                        ...
                        <p className="mb-4">
                            Please enable location services in your browser to
                            use this feature. Here's how:
                        </p>
            ...
            <Card className="w-full h-full overflow-hidden border-0 shadow-none">
                <CardContent className="p-4 h-full flex items-center justify-center">
                    <div className="text-center max-w-md">
                        ...
                        <p className="mb-4">
                            We couldn't detect your location. Would you like to:
                        </p>
                        <div className="space-y-2">
                            <Button
                                onClick={useDefaultLocation}
