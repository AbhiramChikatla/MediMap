...
export default function MapComponentsGoogle({
    ...
    useEffect(() => {
        ...
        placesService.current.nearbySearch(request, (results, status) => {
            if (
                ...
                const hospitals: Hospital[] = results
                    .map((place, index) => {
                        ...
                        if (place.name) {
                            ...
                            for (const [keyword, specialty] of Object.entries(
                                specialtyKeywords
                            )) {
                                if (
                ...
                placesService.current.nearbySearch(
                    ...
                    (clinicResults, clinicStatus) => {
                        if (
                            ...
                            const clinics: Hospital[] = clinicResults
                                .map((place, index) => {
                                    if (
                                        !place.geometry ||
                            ...
                            const allHealthcareProviders = [
                                ...hospitals,
                                ...clinics,
                            ];

                            // Sort by distance
                            allHealthcareProviders.sort(
                                (a, b) =>
                                    (a.distance || Infinity) -
                                    (b.distance || Infinity)
                            );
    ...
    useEffect(() => {
        ...
        loadingIndicator.className =
            "fixed top-4 right-4 bg-white p-2 rounded-md shadow-md z-50";
            ...
            (place, status) => {
                ...
                if (
                    ...
                    setSelectedHospital({
                        ...selectedHospital,
                        address:
                            place.formatted_address || selectedHospital.address,
                        phoneNumber:
        ...
        directionsService.current.route(
            {
                ...
                destination: {
                    lat: selectedHospital.position[0],
                    lng: selectedHospital.position[1],
                },
                ...
                <CardContent className="p-4 h-full flex items-center justify-center">
                    <div className="text-center">
                        <p className="text-red-500">
                            Error loading Google Maps API. Please check your API
                            key.
                        </p>
                    </div>
                </CardContent>
    ...
    const hospitalsToDisplay =
        nearbyHospitals.length > 0 ? nearbyHospitals : filteredHospitals;
                ...
                >
                    ...
                    {hospitalsToDisplay.map((hospital) => (
                        <Marker
                            key={hospital.id}
                            position={{
                                lat: hospital.position[0],
                                lng: hospital.position[1],
                            }}
                    ...
                    {infoWindow && (
                        <InfoWindow
                            position={{
                                lat: infoWindow.position[0],
                                lng: infoWindow.position[1],
                            }}
                            ...
                            <div className="max-w-xs p-2">
                                ...
                                {infoWindow.distance !== undefined && (
                                    <p className="text-xs font-medium mt-1">
                                        Distance:{" "}
                                        {(infoWindow.distance / 1000).toFixed(
                                            1
                                        )}{" "}
                                        km
                                    </p>
                ...
                {selectedHospital && (
                    <div className="absolute bottom-4 left-4 right-4 bg-white rounded-lg shadow-lg p-4 z-10 max-w-md mx-auto overflow-y-auto max-h-[70vh]">
                            ...
                            <div>
                                ...
                                {selectedHospital.distance !== undefined && (
                                    <p className="text-sm font-medium mt-1">
                                        Distance:{" "}
                                        {(
                                            selectedHospital.distance / 1000
                                        ).toFixed(1)}{" "}
                                        km
                                    </p>
                                )}
                                ...
                                {selectedHospital.phoneNumber && (
                                    <p className="text-sm font-medium mt-1">
                                        Phone:{" "}
                                        <a
                                            href={`tel:${selectedHospital.phoneNumber.replace(
                                                /\s+/g,
                                                ""
                                            )}`}
                        ...
                        {selectedHospital.openingHours &&
                            selectedHospital.openingHours.length > 0 && (
                                <div className="mt-3">
                                    <p className="text-sm font-semibold mb-1">
                                        Opening Hours:
                                    </p>
                                    <div className="bg-gray-50 p-2 rounded text-xs">
                                        {selectedHospital.openingHours.map(
                                            (hours, index) => (
                            ...
                            <div className="flex space-x-2">
                                {selectedHospital.phoneNumber && (
                                    <Button
                                        ...
                                        variant="outline"
                                        onClick={() => {
                                            window.location.href = `tel:${selectedHospital.phoneNumber.replace(
                                                /\s+/g,
                                                ""
                                            )}`;
                                        }}
