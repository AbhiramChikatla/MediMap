    ...
    const processSymptoms = async () => {
      if (selectedSymptoms.length > 0) {
        try {
          ...
          const predictedSpecialties = await symptomModelService.processSymptoms(selectedSymptoms);
  ...
  return (
    <Card className="w-full">
      <CardHeader>
        ...
        <CardDescription>
          Select symptoms using the 3D model or add them manually below
        </CardDescription>
      </CardHeader>
      ...
      <CardContent className="space-y-4">
        ...
        {!emergency && (
          <div className="space-y-2">
            ...
            <div className="flex space-x-2">
              ...
              />
              <Button onClick={handleAddCustomSymptom} type="button">
                Add
              </Button>
            </div>
          </div>
        ...
        {specialties.length > 0 && (
          <div className="space-y-2">
            <p className="text-sm font-medium">Recommended Medical Specialties:</p>
            <div className="flex flex-wrap gap-2">
      ...
      <CardFooter>
        <Button 
          ...
          className="w-full" 
          disabled={loading || (selectedSymptoms.length === 0 && !emergency)}
        >
